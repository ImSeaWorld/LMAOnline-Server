...
namespace GSN.Managers
{
    public static class Misc
    {
        ...
        public static TimeSpan DateTimetoExact(DateTime date1, DateTime date2)
        {
            return (date1 - date2);
        }
        ...
        public static DateTime GetDateTime(byte[] dateTime, bool bigEndian = true)
        {
        ...
        public static byte[] SetDateTime(DateTime value, bool bigEndian = true)
        {
        ...
        public static byte[] SetInt32(int value, bool bigEndian = true)
        {
            if (bigEndian)
