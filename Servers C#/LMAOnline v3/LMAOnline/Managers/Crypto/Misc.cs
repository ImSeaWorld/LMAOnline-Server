...
namespace LMAOnline.Managers
{
    public static class Misc
    {
        ...
        public static string[] DateTimetoExact(DateTime date1, DateTime date2) // Returns in array format with a colon as a split.
        {
            TimeSpan tspan = (date1 - date2);
            return String.Format("{0}:{1}:{2}:{3}", tspan.Days, tspan.Hours, tspan.Minutes, tspan.Seconds).Split(':');
        }
